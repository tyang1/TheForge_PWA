...
module.exports = {
  async AWSLogin() {
    ...
    try {
      ...
      console.log(
        "⚠️  Be sure to set up an AWS user in your account's IAM Management Console.\n"
      );
  ...
  async createCLI(projectName) {
    ...
    try {
      ...
      throw new Error(
        'Could not create AWS Application and Environment. You may need to logout with forge -o and reauthenticate your AWS credentials.'
      );
    }
  },
  ...
  deploy() {
    ...
    try {
      ...
      throw new Error(
        'Could not deploy your project to AWS. You may need to logout with forge -o and reauthenticate your AWS credentials.\nError: ',
        err
      );
    }
  },
